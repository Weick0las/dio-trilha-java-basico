...
public class CadastroProdutos {
    ...
    public Set<Produto> exibirProdutosPorNome(){
        Set<Produto> produtosPorNome = new TreeSet<>(produtosSet); //tem que ser treeset, pois o hashset não deixa o set organizado, o treeset vai utilizar do comparable que colocamos na classe produto
